...
const About=()=>{
    return (
        <div>
           ...
           <div className="text-blue-500 ml-96 center mt-8 mr-14 text-base mb-20 font-normal not-italic">
           <p className="text-left">Betahills was founded by Lena Simon in Berlin in 2019.
